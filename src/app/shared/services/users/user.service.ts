...
import { CollectionReference, Firestore, collection, doc, setDoc, getDoc, addDoc, query, where, getDocs, updateDoc, DocumentReference, DocumentData } from '@angular/fire/firestore';
